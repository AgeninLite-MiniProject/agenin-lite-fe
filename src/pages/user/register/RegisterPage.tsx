...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-gray-50">
      <div className="flex-1 flex w-full items-center justify-center p-4 py-8">
        <motion.div
          initial={{ opacity: 0, scale: 0.95 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5 }}
          className="w-full max-w-6xl overflow-hidden rounded-2xl flex bg-white shadow-xl min-h-[650px] border border-gray-100"
        >
          {/* Left side - Map Animasi */}
          <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-700 to-blue-900 border-r border-gray-100">
            <DotMap />
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-12 z-10 bg-black/10">
              ...
              >
                Bergabung sekarang untuk mulai membangun jaringan bisnis dan raih penghasilan tambahan.
              </motion.p>
            </div>
          </div>
